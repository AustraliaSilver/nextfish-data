...
namespace Nextfish {
    ...
    Advice Strategy::consult(Stockfish::Color us, const Stockfish::Position& pos, const Stockfish::Search::Stack* ss, Stockfish::Depth depth [[maybe_unused]], int moveCount [[maybe_unused]]) {
        Advice advice;
