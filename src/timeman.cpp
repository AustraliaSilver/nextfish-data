...
void TimeManagement::init(Search::LimitsType& limits,
    ...
    if (limits.movestogo == 0)
    {
        ...
        optScale = std::min(0.0135 + std::pow(ply + 2.94693, 0.461073) * optConstant,
    ...
    // Nextfish v17: Broadened Time Extension for LTC
    // Be more generous with time if we have a healthy buffer left.
    if (ply > 30 && timeLeft > 10000) optimumTime += optimumTime / 10;
    else if (ply > 40 && ply < 120 && timeLeft > 5000) optimumTime += optimumTime / 12;
